...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="flex md:flex-row flex-col text-center items-center md:px-8 px-2 py-4">
      <div className="flex flex-col md:w-3/4 w-full items-center justify-center mb-4">
        ...
        <a href="/"
        className="p-2 px-8 rounded-full m-2 bg-blue-900 text-bold text-white"
        >Book</a>
      </div>
