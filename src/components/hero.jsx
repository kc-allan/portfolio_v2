...
const Hero = () => {
	return (
	  <div
		id="hero"
		className="mt-[64px] h-screen flex flex-col md:flex-row w-full justify-center px-10 py-4"
	  >
		<div className="md:w-1/2 flex flex-col items-center text-center gap-8">
		  <img
